...
const vcard = 'BEGIN:VCARD\n'  // Gak Usah Di Ganti
            ...
            + 'FN:590Bot\n' //ganti nama bot lu
            + 'ORG: selamat590;\n' //Ganti Jadi Nama Lu
            + 'TEL;type=CELL;type=VOICE;waid=6281394931875:+62 81394931875\n'  //ganti nomor lu! 
            + 'END:VCARD'
prefix = '.' // Ganti Aja Terserah Lu 
blocked = []   //Jangan Ganti
limitawal = 25 //Bebas Ganti 
memberlimit = 5
cr = '*Mikubot*' 

/******** OWNER NUMBER**********/
const ownerNumber = ["6281394931875@s.whatsapp.net"]   // Ganti Nomor Lu
const botNumber = ["6285876224335@s.whatsapp.net"]  // Ganti Jadi Nomor Bot Lu
/************************************/
        ...
        if (levelRole <= 2) {
          ...
          const checkLimit = (sender) => {
           ...
           return false
            ...
            if (isGroup) {
				try {
					const getmemem = groupMembers.length
					    if (getmemem <= memberlimit) {
					    }
